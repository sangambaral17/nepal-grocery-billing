...
const Settings = () => {
    const [settings, setSettings] = useState({
        ...
        phone: '9800000000',
        vatEnabled: false, // Default: VAT disabled
        taxRate: '13',
        currency: 'Rs.'
    });
                ...
                <form onSubmit={handleSave} className="space-y-4">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                        <label className="flex items-center justify-between cursor-pointer">
                            <div>
                                <span className="font-medium text-gray-900">Enable VAT</span>
                                <p className="text-sm text-gray-500 mt-1">Apply VAT (Value Added Tax) to transactions</p>
                            </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <Input
                            ...
                            className={!settings.vatEnabled ? 'opacity-50 cursor-not-allowed' : ''}
                        />
                        <Input
